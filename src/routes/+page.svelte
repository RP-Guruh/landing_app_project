    ...
    <div class="container xl:max-w-6xl mx-auto px-4">
      <div class="lg:flex lg:justify-between">
        <div class="flex justify-between">
          <div
            class="mx-w-10 text-4xl font-bold capitalize text-gray-900 flex items-center"
          >
            Tailone
          </div>
          <!-- mobile nav -->
          <div class="flex flex-row items-center py-4 lg:py-0">
            <div
              class="relative text-gray-900 hover:text-black block lg:hidden"
            >
              <button
                type="button"
              ...
              >
                ...
                <svg
                  ...
                  height="16"
                  fill="currentColor"
                  class="close bi bi-x-lg h-8 w-8"
                  viewBox="0 0 16 16"
                >
                  <path
                    fill-rule="evenodd"
        ...
        <div class="flex flex-row">
          ...
          >
            <li class="relative hover:text-black">
              <a
                class="active block py-3 lg:py-7 px-6 border-b-2 border-transparent"
                href="#hero">Home</a
              >
            </li>
            <li class="relative hover:text-black">
              <a
                class="block py-3 lg:py-7 px-6 border-b-2 border-transparent"
...
<main id="content">
  ...
  <div
    id="hero"
    class="section relative z-0 py-16 md:pt-32 md:pb-20 bg-gray-50"
  >
    <div class="container xl:max-w-6xl mx-auto px-4">
      <div class="flex flex-wrap flex-row -mx-4 justify-center">
        ...
        >
          <img
            src="../src/lib/images/dummy/hero.svg"
        ...
        <!-- text -->
        <div
          class="flex-shrink max-w-full px-4 w-full md:w-9/12 lg:w-1/2 self-center lg:pr-12"
        >
          <div class="text-center lg:text-left mt-6 lg:mt-0">
            <div class="mb-12">
              ...
              >
                We would direct you to limitless ideas and move your brand into
                a global landscape.
              </p>
            </div>
            <a
  ...
  <div id="portfolio" class="section relative z-0 py-12 md:py-16 bg-white">
    ...
    <div class="flex flex-wrap flex-row">
      <figure
        class="flex-shrink max-w-full px-3 w-full sm:w-1/2 lg:w-1/5 group wow fadeInUp"
        data-wow-duration="1s"
      >
        <div class="relative overflow-hidden cursor-pointer mb-6">
          <a
            href="../src/lib/images/dummy/img1.jpg"
          ...
          >
            <img
              class="block w-full h-auto transform duration-500 grayscale hover:scale-125"
              src="../src/lib/images/dummy/img1.jpg"
            ...
            >
              <h3
                class="text-base leading-normal font-semibold my-1 text-white"
              >
                Logo Design
              </h3>
      ...
      >
        <div class="relative overflow-hidden cursor-pointer mb-6">
          <a
            href="../src/lib/images/dummy/img2.jpg"
            data-gallery="gallery1"
            data-glightbox="title: My title; description: This is a wider card with supporting text below as a natural lead-in to additional content"
            class="glightbox3"
          >
            <img
              class="block w-full h-auto transform duration-500 grayscale hover:scale-125"
              src="../src/lib/images/dummy/img2.jpg"
              alt="Image Description"
            />
            <div
              class="absolute inset-x-0 bottom-0 h-20 transition-opacity duration-500 ease-in opacity-0 group-hover:opacity-100 overflow-hidden px-4 py-2 text-gray-100 bg-black text-center"
      ...
      >
        <div class="relative overflow-hidden cursor-pointer mb-6">
          <a
            href="../src/lib/images/dummy/img3.jpg"
            data-gallery="gallery1"
            data-glightbox="title: My title; description: This is a wider card with supporting text below as a natural lead-in to additional content"
            class="glightbox3"
          >
            <img
              class="block w-full h-auto transform duration-500 grayscale hover:scale-125"
              src="../src/lib/images/dummy/img3.jpg"
              alt="Image Description"
            />
            <div
              class="absolute inset-x-0 bottom-0 h-20 transition-opacity duration-500 ease-in opacity-0 group-hover:opacity-100 overflow-hidden px-4 py-2 text-gray-100 bg-black text-center"
      ...
      >
        <div class="relative overflow-hidden cursor-pointer mb-6">
          <a
            href="../src/lib/images/dummy/img4.jpg"
            data-gallery="gallery1"
            data-glightbox="title: My title; description:  This is a wider card with supporting text below as a natural lead-in to additional content"
            class="glightbox3"
          >
            <img
              class="block w-full h-auto transform duration-500 grayscale hover:scale-125"
              src="../src/lib/images/dummy/img4.jpg"
              alt="Image Description"
            />
            <div
              class="absolute inset-x-0 bottom-0 h-20 transition-opacity duration-500 ease-in opacity-0 group-hover:opacity-100 overflow-hidden px-4 py-2 text-gray-100 bg-black text-center"
      ...
      >
        <div class="relative overflow-hidden cursor-pointer mb-6">
          <a
            href="../src/lib/images/dummy/img5.jpg"
            data-gallery="gallery1"
            data-glightbox="title: My title; description:  This is a wider card with supporting text below as a natural lead-in to additional content"
            class="glightbox3"
          >
            <img
              class="block w-full h-auto transform duration-500 grayscale hover:scale-125"
              src="../src/lib/images/dummy/img5.jpg"
              alt="Image Description"
            />
            <div
              class="absolute inset-x-0 bottom-0 h-20 transition-opacity duration-500 ease-in opacity-0 group-hover:opacity-100 overflow-hidden px-4 py-2 text-gray-100 bg-black text-center"
      ...
      >
        <div class="relative overflow-hidden cursor-pointer mb-6">
          <a
            href="../src/lib/images/dummy/img6.jpg"
            data-gallery="gallery1"
          ...
          >
            <img
              class="block w-full h-auto transform duration-500 grayscale hover:scale-125"
              src="../src/lib/images/dummy/img6.jpg"
              alt="Image Description"
            />
            <div
              class="absolute inset-x-0 bottom-0 h-20 transition-opacity duration-500 ease-in opacity-0 group-hover:opacity-100 overflow-hidden px-4 py-2 text-gray-100 bg-black text-center"
      ...
      >
        <div class="relative overflow-hidden cursor-pointer mb-6">
          <a
            href="../src/lib/images/dummy/img7.jpg"
            data-gallery="gallery1"
          ...
          >
            <img
              class="block w-full h-auto transform duration-500 grayscale hover:scale-125"
              src="../src/lib/images/dummy/img7.jpg"
              alt="Image Description"
            />
            <div
              class="absolute inset-x-0 bottom-0 h-20 transition-opacity duration-500 ease-in opacity-0 group-hover:opacity-100 overflow-hidden px-4 py-2 text-gray-100 bg-black text-center"
      ...
      >
        <div class="relative overflow-hidden cursor-pointer mb-6">
          <a
            href="../src/lib/images/dummy/img8.jpg"
            data-gallery="gallery1"
          ...
          >
            <img
              class="block w-full h-auto transform duration-500 grayscale hover:scale-125"
              src="../src/lib/images/dummy/img8.jpg"
              alt="Image Description"
            />
            <div
              class="absolute inset-x-0 bottom-0 h-20 transition-opacity duration-500 ease-in opacity-0 group-hover:opacity-100 overflow-hidden px-4 py-2 text-gray-100 bg-black text-center"
      ...
      >
        <div class="relative overflow-hidden cursor-pointer mb-6">
          <a
            href="../src/lib/images/dummy/img9.jpg"
            data-gallery="gallery1"
            data-glightbox="title: Graphic Design; description: This is a wider card with supporting text below as a natural lead-in to additional content"
            class="glightbox3"
          >
            <img
              class="block w-full h-auto transform duration-500 grayscale hover:scale-125"
              src="../src/lib/images/dummy/img9.jpg"
              alt="Image Description"
            />
            <div
              class="absolute inset-x-0 bottom-0 h-20 transition-opacity duration-500 ease-in opacity-0 group-hover:opacity-100 overflow-hidden px-4 py-2 text-gray-100 bg-black text-center"
      ...
      >
        <div class="relative overflow-hidden cursor-pointer mb-6">
          <a
            href="../src/lib/images/dummy/img10.jpg"
            data-gallery="gallery1"
          ...
          >
            <img
              class="block w-full h-auto transform duration-500 grayscale hover:scale-125"
              src="../src/lib/images/dummy/img10.jpg"
              alt="Image Description"
            />
            <div
              class="absolute inset-x-0 bottom-0 h-20 transition-opacity duration-500 ease-in opacity-0 group-hover:opacity-100 overflow-hidden px-4 py-2 text-gray-100 bg-black text-center"
                ...
                <div class="splide__slide">
                  <div class="w-full px-4 text-center pb-3">
                    <a href="www.google.com" target="_blank">
                      <img
                        class="grayscale mx-auto opacity-80 hover:opacity-100 max-w-full h-auto"
                        src="../src/lib/images/dummy/img1.png"
                        alt="Image Description"
                      />
                    </a>
                  </div>
                ...
                <div class="splide__slide">
                  <div class="w-full px-4 text-center pb-3">
                    <a href="www.google.com" target="_blank">
                      <img
                        class="grayscale mx-auto opacity-80 hover:opacity-100 max-w-full h-auto"
                        src="../src/lib/images/dummy/img2.png"
                        alt="Image Description"
                      />
                    </a>
                  </div>
                ...
                <div class="splide__slide">
                  <div class="w-full px-4 text-center pb-3">
                    <a href="www.google.com" target="_blank">
                      <img
                        class="grayscale mx-auto opacity-80 hover:opacity-100 max-w-full h-auto"
                        src="../src/lib/images/dummy/img3.png"
                        alt="Image Description"
                      />
                    </a>
                  </div>
                ...
                <div class="splide__slide">
                  <div class="w-full px-4 text-center pb-3">
                    <a href="www.google.com" target="_blank">
                      <img
                        class="grayscale mx-auto opacity-80 hover:opacity-100 max-w-full h-auto"
                        src="../src/lib/images/dummy/img4.png"
                        alt="Image Description"
                      />
                    </a>
                  </div>
                ...
                <div class="splide__slide">
                  <div class="w-full px-4 text-center pb-3">
                    <a href="www.google.com" target="_blank">
                      <img
                        class="grayscale mx-auto opacity-80 hover:opacity-100 max-w-full h-auto"
                        src="../src/lib/images/dummy/img5.png"
                        alt="Image Description"
                      />
                    </a>
                  </div>
                ...
                <div class="splide__slide">
                  <div class="w-full px-4 text-center pb-3">
                    <a href="www.google.com" target="_blank">
                      <img
                        class="grayscale mx-auto opacity-80 hover:opacity-100 max-w-full h-auto"
                        src="../src/lib/images/dummy/img6.png"
                        alt="Image Description"
                      />
                    </a>
                  </div>
      ...
      <div class="flex flex-wrap flex-row -mx-4 justify-center">
        ...
        >
          ...
          >
            ...
            <div class="relative overflow-hidden px-6">
              <img
                src="../src/lib/images/dummy/avatar1.png"
        ...
        >
          ...
          >
            <div class="relative overflow-hidden px-6">
              <img
                src="../src/lib/images/dummy/avatar3.png"
                class="max-w-full h-auto mx-auto rounded-full bg-gray-50 grayscale"
                alt="title image"
              />
            </div>
        ...
        >
          ...
          >
            <div class="relative overflow-hidden px-6">
              <img
                src="../src/lib/images/dummy/avatar2.png"
                class="max-w-full h-auto mx-auto rounded-full bg-gray-50 grayscale"
                alt="title image"
              />
            </div>
        ...
        >
          ...
          >
            <div class="relative overflow-hidden px-6">
              <img
                src="../src/lib/images/dummy/avatar4.png"
                class="max-w-full h-auto mx-auto rounded-full bg-gray-50 grayscale"
                alt="title image"
              />
            </div>
        ...
        <div class="max-w-ful px-4 w-full lg:w-8/12">
          ...
          >
            ...
            <header class="text-center mx-auto mb-12 lg:px-20">
              ...
              <p
                class="text-gray-600 leading-relaxed font-light text-xl mx-auto pb-2"
              >
...
<footer class="bg-gray-50 text-gray-700">
      ...
      <div class="flex flex-wrap flex-row lg:justify-between -mx-3">
        <div class="flex-shrink max-w-full w-full lg:w-2/5 px-3 lg:pr-16">
          <div class="flex items-center mb-2">
            <span
              class="text-3xl leading-normal mb-2 font-bold text-gray-800 mt-2"
              >Tailone</span
            >
            <!-- <img src="../src/lib/images-min/logo.png" alt="LOGO"> -->
          </div>
        ...
        <div class="flex-shrink max-w-full w-full lg:w-3/5 px-3">
          <div class="flex flex-wrap flex-row">
            <div class="flex-shrink max-w-full w-1/2 md:w-1/3 mb-6 lg:mb-0">
              <h4 class="text-base leading-normal mb-3 uppercase text-gray-800">
                Support
              </h4>
              <ul>
            ...
            <div class="flex-shrink max-w-full w-1/2 md:w-1/3 mb-6 lg:mb-0">
              ...
              <ul>
                <li class="py-1 hover:text-gray-900">
                  <a href="www.google.com">Tailwind Css</a>
                </li>
                <li class="py-1 hover:text-gray-900">
                  <a href="www.google.com">Javascript</a>
                </li>
                <li class="py-1 hover:text-gray-900">
                  <a href="www.google.com">Vendors Js</a>
                </li>
                <li class="py-1 hover:text-gray-900">
                  <a href="www.google.com">Build System</a>
                </li>
              </ul>
            </div>
            <div class="flex-shrink max-w-full w-1/2 md:w-1/3 mb-6 lg:mb-0">
  ...
  <div class="footer-dark">
    <div
      class="container xl:max-w-6xl mx-auto px-4 py-4 border-t border-gray-200 border-opacity-10"
    >
      <div class="row">
